...
exports.seed = async function (knex) {
  ...
  await knex('skills').insert([
    ...
    { id: 2, user_id: 1, category_id: 3, skill: 'Cooking', role: 'learn' },
    { id: 3, user_id: 1, category_id: 2, skill: 'BJJ', role: 'teach' },
    { id: 4, user_id: 1, category_id: 2, skill: 'Fencing', role: 'teach' },
    {
      id: 5,
      user_id: 1,
      category_id: 9,
    ...
    { id: 9, user_id: 3, category_id: 5, skill: 'Bicep curls', role: 'teach' },
    ...
    { id: 21, user_id: 5, category_id: 2, skill: 'Roleplaying', role: 'teach' },
    {
      id: 22,
      user_id: 5,
      category_id: 4,
    ...
    { id: 31, user_id: 7, category_id: 3, skill: 'Photography', role: 'learn' },
    {
      id: 32,
      user_id: 8,
      category_id: 6,
      skill: 'Fine dining appreciation',
      role: 'teach',
    },
    {
      id: 33,
    ...
    { id: 36, user_id: 8, category_id: 9, skill: 'Spanish', role: 'learn' },
    { id: 37, user_id: 9, category_id: 2, skill: 'Fishing', role: 'teach' },
    {
      id: 38,
      user_id: 9,
      category_id: 1,
    ...
    { id: 39, user_id: 9, category_id: 7, skill: 'Philosopy', role: 'learn' },
    { id: 40, user_id: 9, category_id: 2, skill: 'Meditation', role: 'learn' },
    { id: 41, user_id: 2, category_id: 8, skill: 'Redux', role: 'teach' },
    {
      id: 42,
      user_id: 2,
      category_id: 2,
    ...
    { id: 43, user_id: 2, category_id: 8, skill: 'Javascript', role: 'teach' },
    { id: 44, user_id: 3, category_id: 2, skill: 'Yoga', role: 'teach' },
    ...
    { id: 47, user_id: 3, category_id: 5, skill: 'Connect4', role: 'teach' },
    {
      ...
      user_id: 2,
      category_id: 6,
      skill: 'Baking and patisseries',
      role: 'learn',
    },
    { id: 49, user_id: 2, category_id: 7, skill: 'Drums', role: 'teach' },
    {
      id: 50,
      user_id: 2,
      category_id: 2,
    ...
    { id: 51, user_id: 2, category_id: 3, skill: 'Cooking', role: 'learn' },
    {
      id: 52,
      user_id: 10,
      category_id: 3,
